...
$(document).ready(function() {
    ...
    table = $('#table-dashboard').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kasie_ws/dashboard/order_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    ...
    table_r = $('#table-response').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('kasie_ws/response/order_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    ...
    table_reject = $('#table-reject').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('kasie_ws/response/tolak_list')?>",
            "type": "POST"
        },
