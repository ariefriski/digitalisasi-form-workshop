...
<h3 class="block-title" style="text-align: center;">2. Response PIC Workshop</h3> 
        ...
        <?php foreach($accept as $a) { ?>
            <form action="<?php echo base_url()?>kadept_ws/dashboard/acceptKadeptWs" method="post">
            ...
            <div class="form-group row" >
                    ...
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_order_response" id="accept" value="accept" <?php if($a['status_approval']=='Disetujui') echo 'checked'?> disabled>
                        <span class="css-control-indicator"></span> Accept
                    </label>
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_order_response" id="reject" value="reject" <?php if($a['status_approval']=='Ditolak') echo 'checked'?> disabled>
                ...
                <label class="col-8" for="example-text-input">Kasie Workshop Approval</label>
                    ...
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_kasie" id="accept" value="accept" <?php if($a['status_approval']=='Disetujui') echo 'checked'?> disabled>
                        <span class="css-control-indicator"></span> Accept
                    </label>
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_kasie" id="reject" value="reject" <?php if($a['status_approval']=='Ditolak') echo 'checked'?> disabled>
                        <span class="css-control-indicator"></span> Reject
                    </label>
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <span class="css-control-indicator"></span> Signed By <?php echo $a['jenis_approval_1'] ?>
                    </label>
                    <?php }else{?>
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                ...
                <?php if($a['jenis_approval']!=NULL){ ?>
                    <label class="col-8" for="example-text-input">Kadept Workshop Approval</label>
                    <div class="col-6">
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_kadept" id="accept" value="accept" <?php if($a['jenis_approval_2']!=NULL) echo 'checked'?> disabled >
                        <span class="css-control-indicator"></span> Accept
                    </label>
                    <label class="css-control css-control-lg css-control-primary css-checkbox css-checkbox-rounded">
                        <input type="radio" class="css-control-input" name="r_kadept" id="reject" value="reject" <?php if($a['jenis_approval_2']==NULL) echo 'checked'?> disabled> 
                        <span class="css-control-indicator"></span> Reject
                    </label>
                 <?php }?>
            </div>
                <div  id="reason1">
                <?php if($a['alasan_3'] != NULL){ ?>
