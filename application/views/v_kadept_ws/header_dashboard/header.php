                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            ...
                            <li>
                                <a href="<?= base_url() . 'kadept_ws/response'?>"><i class="fa fa-check"></i><span class="sidebar-mini-hide">Sudah Disetujui</span></a>
                            </li>
                            <li>
                                <a href="<?= base_url() . 'kadept_ws/response/reject'?>"><i class="fa fa-times"></i><span class="sidebar-mini-hide">Ditolak</span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- END Side Navigation -->
