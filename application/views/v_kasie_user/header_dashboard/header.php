            ...
            <nav id="sidebar">
                ...
                <div class="sidebar-content">
                    ...
                    <div class="content-side content-side-full">
                        <ul class="nav-main">
                            <li>
                                <a href="<?= base_url() . 'kasie_user/dashboard'?>"><i class="si si-cup"></i><span class="sidebar-mini-hide">Menunggu Persetujuan</span></a>
                            </li>
                            <li>
                                <a href="<?= base_url() . 'kasie_user/response'?>"><i class="fa fa-newspaper-o"></i><span class="sidebar-mini-hide">Sudah Disetujui</span></a>
                            </li>
                            <li>
                                <a href="<?= base_url() . 'kasie_user/response/reject'?>"><i class="fa fa-newspaper-o"></i><span class="sidebar-mini-hide">Ditolak</span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- END Side Navigation -->
