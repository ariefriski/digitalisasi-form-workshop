...
$(document).ready(function() {
    ...
    table = $('#table-dashboard').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('kadept_user/dashboard/order_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    ...
    // DATATABLE DASHBOARD
    table = $('#table-response').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('kadept_user/response/order_list')?>",
            "type": "POST"
        },
...
$(document).ready(function() {
    ...
    table_reject = $('#table-reject').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('kadept_user/response/tolak_list')?>",
            "type": "POST"
        },
